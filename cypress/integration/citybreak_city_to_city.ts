describe('City Break - city to city with offers', () => {
    ...
    it('Verifies search results are loaded properly', () => {
...
describe('City Break - city to city without offers', () => {
    ...
    it('Verifies check offers button exists', () => {
        cy.get('a[data-qa-offers-teaser-link-overlay]').should('exist')
    })

    it('Verifies search results are loaded properly', () => {
        cy.get('a[data-qa-offers-teaser-link-overlay]').click()
